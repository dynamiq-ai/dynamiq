...
def get_documuments():
    documents = [
        ...
        Document(content="Lviv is a city in western Ukraine", metadata={"city": "Lviv"}),
        Document(content="Lviv is a city with a rich history", metadata={"city": "Lviv"}),
        Document(content="Lviv is a city with a lot of tourists", metadata={"city": "Lviv"}),
        Document(content="Odessa is a city in southern Ukraine", metadata={"city": "Odessa"}),
        Document(content="Kharkiv is a great city in Ukraine", metadata={"city": "Kharkiv"}),
        Document(
