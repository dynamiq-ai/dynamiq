...
def initialize_vector_stores(pinecone_connection, weaviate_connection, chroma_connection):
    pinecone_vector_store = PineconeVectorStore(index_name="default", connection=pinecone_connection)
    chroma_vector_store = ChromaVectorStore(index_name="default", connection=chroma_connection)
    weaviate_vector_store = WeaviateVectorStore(index_name="default", connection=weaviate_connection)
...
def main():
    pinecone_connection, weaviate_connection, chroma_connection = initialize_connections()
    pinecone_vector_store, chroma_vector_store, weaviate_vector_store = initialize_vector_stores(
