...
def setup_multi_tool_agent() -> Agent:
    ...
    Returns:
        Agent: Configured ReAct agent with multi-tool capabilities.
    """
...
def run_workflow(agent: Agent = setup_multi_tool_agent(), input_prompt: str = EXAMPLE_QUERY) -> tuple[str, dict]:
    """
