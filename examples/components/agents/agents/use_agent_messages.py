...
def run_reflection_agent_message_workflow() -> tuple[str, dict]:
    """
...
def run_react_agent_message_workflow() -> tuple[str, dict]:
    """
...
def run_simple_agent_message_workflow() -> tuple[str, dict]:
    """
    ...
    try:
        result = wf.run(
            input_data={
                "input": "Hello tell me about Google",
                "context": "Keep answer short and simple",
            },
            config=RunnableConfig(callbacks=[tracing]),
        )
...
def run_reflection_agent_vision_message_workflow() -> tuple[str, dict]:
    """
    Set up and run a workflow using a ReflectionAgent with OpenAI's language model.
...
def run_react_agent_vision_message_workflow() -> tuple[str, dict]:
    """
    Set up and run a workflow using a ReActAgent with OpenAI's language model.
...
def run_simple_agent_vision_message_workflow() -> tuple[str, dict]:
    """
    Set up and run a workflow using a SimpleAgent with OpenAI's language model.
