...
from dynamiq.nodes.splitters import BreakpointThresholdType, SemanticChunker
...
def main() -> None:
    ...
    output = chunker.execute(chunker.input_schema(documents=[Document(content=text)]))
