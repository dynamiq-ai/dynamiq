...
if __name__ == "__main__":
    ...
    result = agent.run(input_data={"input": "Show me content of example.com"}, config=None)

    print("Agent's response:")

    print(result.output)

    result = agent.run(input_data={"input": "Show me some random fact about cat"}, config=None)
