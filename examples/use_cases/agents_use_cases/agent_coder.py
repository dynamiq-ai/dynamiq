...
def save_agent_files(files: dict, output_dir: str = "./agent_outputs") -> None:
    """
    Save files generated by agent, handling both data URIs and plain base64.

    Args:
        files: Dictionary mapping file paths to content (base64 or data URI)
