"""Strict-tools smoke test for DeepSeek (per-tool ``strict`` via OpenAIStrictToolsMixin)."""
...
def _llm():
    return DeepSeek(connection=DeepSeekConnection(), model="deepseek/deepseek-chat", max_tokens=4096, temperature=1)
