...
class CreatePageInputSchema(BaseModel):
    """
    Input schema for creating a new page in a  doc.
    """
...
class CreatePage(BaseCoda):
    """
    Node to create a new page within a  doc.
    """

    name: str = "CreatePage"
    description: str = "Create a new page in a  doc."
    input_schema: ClassVar[type[CreatePageInputSchema]] = CreatePageInputSchema

    def execute(self, input_data: CreatePageInputSchema, config: RunnableConfig | None = None, **kwargs):
