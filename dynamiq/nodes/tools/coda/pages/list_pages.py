...
class ListPagesInputSchema(BaseModel):
    """
    Input schema for listing pages in a  doc.
    """
...
class ListPages(BaseCoda):
    """
    Node to list pages in a  doc.
    """

    name: str = "ListPages"
    description: str = "Fetch a list of pages from a given  doc."
    input_schema: ClassVar[type[ListPagesInputSchema]] = ListPagesInputSchema

    def execute(self, input_data: ListPagesInputSchema, config: RunnableConfig | None = None, **kwargs):
