...
from ..base import BaseCoda, RowEdit


class InsertUpsertRowsInputSchema(BaseModel):
    """
    Input schema for inserting/upserting rows in a  table.
    """
...
class InsertUpsertRows(BaseCoda):
    """
    Node to insert or upsert rows in a  table.
    """

    name: str = "InsertUpsertRows"
    description: str = "Insert or upsert rows into a  table."
    input_schema: ClassVar[type[InsertUpsertRowsInputSchema]] = InsertUpsertRowsInputSchema

    def execute(self, input_data: InsertUpsertRowsInputSchema, config: RunnableConfig | None = None, **kwargs):
