...
class ListTableRowsInputSchema(BaseModel):
    """
    Input schema for listing rows in a  table.
    """
...
class ListTableRows(BaseCoda):
    """
    Node to list rows in a specified table of a  doc.
    """

    name: str = "ListTableRows"
    description: str = "Fetch a list of rows from a given table in a  doc."
    input_schema: ClassVar[type[ListTableRowsInputSchema]] = ListTableRowsInputSchema

    def execute(self, input_data: ListTableRowsInputSchema, config: RunnableConfig | None = None, **kwargs):
