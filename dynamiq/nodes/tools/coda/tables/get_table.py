...
class GetTableInputSchema(BaseModel):
    """
...
class GetTable(BaseCoda):
    """
    Node to get details about a specific table or view in a  doc.
    """

    name: str = "GetTable"
    description: str = "Fetch detailed info about a table/view in a  doc."
    input_schema: ClassVar[type[GetTableInputSchema]] = GetTableInputSchema

    def execute(self, input_data: GetTableInputSchema, config: RunnableConfig | None = None, **kwargs):
