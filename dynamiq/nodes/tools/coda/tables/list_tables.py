...
class ListTablesInputSchema(BaseModel):
    """
    Input schema for listing tables in a  doc.
    """
...
class ListTables(BaseCoda):
    """
    Node to list tables or views in a  doc.
    """

    name: str = "ListTables"
    description: str = "Fetch a list of tables/views from a given  doc."
    input_schema: ClassVar[type[ListTablesInputSchema]] = ListTablesInputSchema

    def execute(self, input_data: ListTablesInputSchema, config: RunnableConfig | None = None, **kwargs):
