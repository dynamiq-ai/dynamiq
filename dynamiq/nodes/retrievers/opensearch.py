...
from dynamiq.components.retrievers.opensearch import OpenSearchDocumentRetriever as OpenSearchDocumentRetrieverComponent
...
class OpenSearchDocumentRetriever(Retriever, OpenSearchVectorStoreParams):
    """
