...
class MilvusDocumentWriter(VectorStoreNode, MilvusWriterVectorStoreParams):
    """
    ...
    Attributes:
        ...
        connection (Milvus | None): The Milvus connection object.
        vector_store (MilvusVectorStore | None): The Milvus Vector Store object.
    """
    ...
    def check_required_params(self) -> "MilvusDocumentWriter":
        ...
        if self.vector_store is None:
            if self.create_if_not_exist and self.index_type is None:
                raise ValueError("Logic type for creation should be specified.")
