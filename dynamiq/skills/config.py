...
class SkillsConfig(BaseModel):
    ...
    source: BaseSkillRegistry | None = Field(default=None, description="Registry providing skills.")

    model_config = ConfigDict(arbitrary_types_allowed=True)

    @field_validator("source", mode="before")
    @classmethod
    def resolve_source(cls, v: Any):
        ...
        if isinstance(v, dict):
            ...
            init_data = {k: value for k, value in v.items() if k != "type"}
